...
public class DBCourseNewManager {
    ...
    public void add(List<Course> courses) {
        ...
        try {
            for (Course course : courses) {
                db.execSQL("INSERT INTO coursenew VALUES(null, ?, ?, ?)", new Object[]{course.xn,course.xq,course.xqj,course.djj,course.qsz,course.jsz,course.kcb,course.dsz,course.skcd});
            }
    ...
    {
        String xsql="insert into coursenew  values (\'"+course.xn+"\',\'"+course.xq+"\',\'"+course.xqj+"\',\'"+course.djj+"\',\'"+course.qsz+"\',\'"+course.jsz+"\',\'"+course.kcb+"\',\'"+course.dsz+"\',\'"+course.skcd+"\')";
        db.execSQL(xsql);
    }

    public void delete(String XN,String XQ)
    {
        String xsql="delete from coursenew where xn=\'"+XN+"\' AND xq=\'"+XQ+"\'";
        db.execSQL(xsql);
    }
    /**
    ...
    public Cursor queryTheCursor(String xn,String xq) {
        Cursor c = db.rawQuery("SELECT * FROM coursenew where xn=\'"+xn+"\' AND xq=\'"+xq+"\'", null);
    ...
    {
        String xsql="delete from coursenew where xn=\'"+xn+"\' AND xq=\'"+xq+"\' AND kcb=\'"+kcb+"\'";
        db.execSQL(xsql);
    }
