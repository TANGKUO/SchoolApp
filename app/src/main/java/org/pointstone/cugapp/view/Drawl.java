...
import org.pointstone.cugapp.utils.ScreenUtils;
...
//        bitmap = Bitmap.createBitmap(480, 854, Bitmap.Config.ARGB_8888); // 设置位图的宽高
        bitmap = Bitmap.createBitmap(ScreenUtils.getScreenDispaly(context)[0], ScreenUtils.getScreenDispaly(context)[1], Bitmap.Config.ARGB_8888);
        canvas = new Canvas();
...
//                    //代表用户绘制的密码手势与传入的密码相同
//                    callBack.checkedSuccess(passWord.toString());
//                }else{
//                    //用户绘制的密码与传入的密码不同。
