...
import static io.yunba.android.manager.YunBaManager.TAG;


public class CourseNewWidget extends AppWidgetProvider {

    public static final String COLLECTION_VIEW_NEW_ACTION = "org.pointstone.cugapp.COLLECTION_VIEW_NEW_ACTION";
    public static final String COLLECTION_VIEW_NEW_EXTRA = "org.pointstone.cugapp.COLLECTION_VIEW_NEW_EXTRA";
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (action.equals(COLLECTION_VIEW_NEW_ACTION)) {
            // 接受“gridview”的点击事件的广播

            int viewIndex = intent.getIntExtra(COLLECTION_VIEW_NEW_EXTRA, 0);
            //求余得到二维索引
        ...
        } else if (action.equals("org.pointstone.cugapp.Widget.Button.New.Update")) {
            RemoteViews view = new RemoteViews(context.getPackageName(), R.layout.widget_course_new);
            ...
            appWidgetManager.notifyAppWidgetViewDataChanged(widgetId, R.id.gv_widget_display);
    ...
    public void getCourse(Context context, RemoteViews rv, int cw) {
        ...
        Intent serviceIntent = new Intent(context, GridNewWidgetService.class);
        // serviceIntent.putExtra("a",con[0][0]);
        rv.setRemoteAdapter(R.id.gv_widget_display, serviceIntent);
    }
    ...
    private PendingIntent getClickIntent(Context context, int widgetId, int viewId, int requestCode, String action) {
        ...
        Intent i = new Intent(context, CourseNewWidget.class);
        //设置action
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        ...
        if (status == 1 && login == 1) {
            ...
            for (int appWidgetId : appWidgetIds) {
                // 获取AppWidget对应的视图
                RemoteViews rv = new RemoteViews(context.getPackageName(), R.layout.widget_course_new);
                ...
                rv.setOnClickPendingIntent(R.id.next_tv, getClickIntent(context, appWidgetId, R.id.next_tv, 0, "org.pointstone.cugapp.Widget.Button.New.Update"));
                rv.setOnClickPendingIntent(R.id.before_tv, getClickIntent(context, appWidgetId, R.id.before_tv, 1, "org.pointstone.cugapp.Widget.Button.New.Update"));
                rv.setOnClickPendingIntent(R.id.week_tv, getClickIntent(context, appWidgetId, R.id.week_tv, 2, "org.pointstone.cugapp.Widget.Button.New.Update"));
                ...
                gridIntent.setAction(COLLECTION_VIEW_NEW_ACTION);
                ...
                // 设置intent模板
                rv.setPendingIntentTemplate(R.id.gv_widget_display, pendingIntent);

                // 调用集合管理器对集合进行更新
                appWidgetManager.notifyAppWidgetViewDataChanged(appWidgetId, R.id.gv_widget_display);
